...
local mappings = {
   ...
   s = {
      ...
      p = { "<cmd>lua require('telescope.builtin').projects()<cr>", "Find Project" },
      b = { "<cmd>lua require('telescope.builtin').buffers()<cr>", "Find Buffer" },
      B = { "<cmd>lua require('telescope.builtin').git_branches()<cr>", "Checkout branch" },
      c = { "<cmd>lua require('telescope.builtin').colorscheme()<cr>", "Show Colorschemes" },
      h = { "<cmd>lua require('telescope.builtin').help_tags()<cr>", "Find Help" },
      M = { "<cmd>lua require('telescope.builtin').man_pages()<cr>", "Find Man Pages" },
